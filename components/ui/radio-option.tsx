...
function RadioOption({
  ...
  return (
    <label
      className={cn(
        "group flex cursor-pointer items-start gap-4 rounded-[1.4rem] border border-border/80 bg-white/75 px-4 py-3 transition-all duration-200 hover:-translate-y-0.5 hover:border-[var(--gs-soft)] hover:bg-white",
        checked &&
